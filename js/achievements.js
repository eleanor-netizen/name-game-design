...
const Achievements = (() => {
  ...
  const BADGES = [
    ...
    { id: 'chain_az_50pct_1x', category: 'Name Chain Mastery', icon: '🔗', title: 'Familiar Territory',
      desc: 'Complete A to Z with at least 50% 1x-rarity names',
      test: (r) => isChainAZ(r) && r.roundEntries.filter((e) => e.tier === 1).length / r.roundEntries.length >= 0.5 },
    { id: 'chain_az_no4x', category: 'Name Chain Mastery', icon: '🔗', title: 'Playing It Safe',
      desc: 'Complete A to Z using no 4x-rarity names',
      test: (r) => isChainAZ(r) && r.roundEntries.every((e) => e.tier !== 4) },
